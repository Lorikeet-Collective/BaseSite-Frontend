    ...
    <main>
      ...
      <Dropdown title={"Which insurances do you take?"}>
        <p>
          ...
          list of which insurances your specific therapist accepts, view their
          bio on the Meet the Flock page!
        </p>
        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                Have an insurance policy that offers Out-Of-Network benefits;
                AND
              </li>
          ...
          <li>
            ...
            your insurance as they won’t be covering costs. This is a good
            option for folx who:
            <ul>
              <li>Have limited access to financial resources; AND</li>
              <li>
                Have an existing insurance policy with a high deductible,
                limited mental health benefits, or no Out-Of-Network benefits;
                AND
              </li>
              <li>Want to financially support our work.</li>
            </ul>
          ...
          <li>
            <b>Pro-Bono:</b> You receive our therapeutic services free of
            charge. Regardless of whether you are insured, our work is not
            reported to your insurance as they won’t be covering costs. We are
            honored to provide pro bono services to those who:
            <ul>
              <li>
                Have severely restricted access to financial resources; AND
              </li>
              <li>
              ...
              <li>
                Are seeking treatment for current mental health challenges.
              </li>
            </ul>
          </li>
          <li>
            <b>Out-Of-Pocket:</b> You pay the full price of each session either
            in one payment or in multiple scheduled, smaller payments until the
            fee is paid in full (also known as a “Payment Plan”). Regardless of
            whether you are insured, our work is not reported to your insurance
            as they won’t be covering costs. This is a good option for folx who:
            <ul>
              <li>
                Have comfortable, reliable access to abundant financial
                resources; AND
              </li>
              <li>
                Prefer to work without us reporting to your insurance; AND
              </li>
              <li>Want to financially support our work.</li>
            </ul>
          </li>
      ...
      <Dropdown title={"How is sliding scale decided?"}>
        ...
        <p>
          To determine eligibility for sliding scale fees, your therapist may
          ask questions including but not limited to:
        </p>
        <ul>
        ...
        <p>
          ...
          inquiring if a sliding scale rate may be right for you, please reach
          out to your therapist directly.
        </p>
      </Dropdown>
      <Dropdown title={"What are your rates?"}>
        <p>
          We at Lorikeet Collective have seen how rising costs of living have
          impacted goods and services across so many industries, and mental
          health care is no different. We’re here to do things differently,
          because we take pride in being accessible for our community while
          supporting our therapists. This means lower rates for clients and
          higher returns to clinicians.
        </p>
        ...
        <ul>
          ...
          <li>
            <b>$0</b> always for single-session gender affirming care
      ...
      <Dropdown title={"Can Lorikeet Collective adjust my copay?"}>
        <p>
          ...
          insurance coverage, copay responsibility, applicable deductibles, or
          any fees associated. If you are experiencing financial hardship and
          cannot afford your therapy, please speak with your therapist.
        </p>
      </Dropdown>
      <Dropdown
      ...
      >
        <p>
          ...
          to find more information specific to your policy. Please note that
          while it can be helpful to find information online through forums or
          Google, it is important to know that coverage may vary due to region,
      ...
      <Dropdown title={"How do I recieve invoices?"}>
        <p>
          ...
          statements, bills, or super bills both in the client portal and to
          your email. All balances and copays can be paid directly in the client
          portal.
        </p>
      </Dropdown>
      <Dropdown title={"My copay is $0. Why do you need my credit card?"}>
        <p>
          ...
          card to be on file to receive services if you have a $0 copay.
          However, our electronic health platform Sessions Health still may
          request your credit card to be placed on file automatically. At this
          time, this can be skipped during the process of submitting onboarding
          documents.
        </p>
        <p>
          If you anticipate your insurance changing, please let us know so we
      ...
      <Dropdown title={"Where can I direct additional questions?"}>
        <p>
          ...
          deductibles, co-pays, or network, please contact your insurance
          provider using the methods designated on your insurance card.
        </p>
        <p>
          For questions about our rates or any charges you have received from
          Lorikeet Collective, please reach out to our billing and
