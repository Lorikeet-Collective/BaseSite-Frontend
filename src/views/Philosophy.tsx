    ...
    <main>
      ...
      <div className="desktop-grid">
        ...
        <div>
          ...
          <p>
            ...
            therapeutic spaces should inclusive and affirming for all
            LGBTQAI2S+, disabled, neurodiverse, BIPOC, and multiply marginalized
            folx— from those who find themselves looking for a safe place to
            heal to those called upon to heal others.
          </p>
        </div>
        {!isClamped && <SinWave />}
        <div>
      ...
      <Dropdown title="Which principles guide your therapeutic approach?">
        ...
        <ul>
          ...
          <li>
            Conversion therapy (anti-LGBTQIA2S+ or applied behavior analysis/
            ABA) is inherently traumatic and therefore, abuse.
          </li>
